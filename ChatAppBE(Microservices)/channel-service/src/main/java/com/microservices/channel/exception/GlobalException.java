package com.microservices.channel.exception;
...
public class GlobalException {
    ...
    public ResponseEntity<ErrorDetail> ChannelExceptionHandler(ChannelException e, WebRequest req) {
        ErrorDetail err = new ErrorDetail(e.getMessage(), req.getDescription(false), LocalDateTime.now());

        return new ResponseEntity<ErrorDetail>(err, HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(ChannelMessageException.class)
    public ResponseEntity<ErrorDetail> ChannelMessageExceptionHandler(ChannelMessageException e, WebRequest req) {
        ErrorDetail err = new ErrorDetail(e.getMessage(), req.getDescription(false), LocalDateTime.now());
