...
public class GlobalException {
    ...
    public ResponseEntity<ErrorDetail> GroupExceptionHandler(GroupException e, WebRequest req) {
    ...
    public ResponseEntity<ErrorDetail> GroupMessageExceptionHandler(GroupMessageException e, WebRequest req) {
        ErrorDetail err = new ErrorDetail(e.getMessage(), req.getDescription(false), LocalDateTime.now());
